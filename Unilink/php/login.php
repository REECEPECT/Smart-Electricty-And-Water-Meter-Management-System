...
<head>
	...
	<title>Unilink</title>
	<link rel="stylesheet" href="/unilink/css/login.css">
</head>
<body>
	<div class = "hero">
		<div class = "form-box">
		<div class = "button-box">
			...
			<form action = "views/signup.inc.php" id = "register" class = "input-group" method="post">
				...
				<input type="text" class = "input-field" name="reppassword" placeholder="Repeat Password" required>
				<button type="submit" name = "submit" class="submit-btn">Register</button>
				<div class="form-group">
				<input type="checkbox" name="agree"/> By checking this box, you give us consent to store and process your personal information inaccordance with <a href="#">Privacy Policy.</a>
				</div>
