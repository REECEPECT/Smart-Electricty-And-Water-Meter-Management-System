        ...
        <div class="main">
            ...
            <div class="cardBox">
                <div class="card" id="elecBtn">
                    <div>
                        <div class="numbers"><?php echo $elec;?></div>
                ...
                <div class="card" id="watBtn">
                    <div>
                        <div class="numbers"><?php echo $water;?></div>
                ...
                <div class="card">
                    <div>
                        <div class="numbers"><?php echo $elec_cons;?></div>
                ...
                <div class="card">
                    <div>
                        <div class="numbers"><?php echo $water_cons;?></div>
            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    function drawChart() {
                        ...
                        chart.draw(data, options);
                         ...
                         <div id="curve_chart" style="width: 830px; height: 600px; "></div>
                        </div>
                ...
                <div class="cont">
                    <form action="recharge.inc.php" method="POST">
